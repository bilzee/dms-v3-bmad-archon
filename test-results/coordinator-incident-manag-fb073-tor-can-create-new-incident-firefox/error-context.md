...
- dialog "Unhandled Runtime Error" [ref=e3]:
  - generic [ref=e4]:
    ...
    - generic [ref=e25]:
      ...
      - generic [ref=e27]:
        - link "src\\components\\coordinator\\IncidentManagement.tsx (353:22) @ prev" [ref=e29] [cursor=pointer]:
          - generic [ref=e30]: src\components\coordinator\IncidentManagement.tsx (353:22) @ prev
          - img [ref=e31]
        - generic [ref=e35]: "351 | {showCreateButton && ( 352 | <Dialog open={state.showCreateModal} onOpenChange={(open) => > 353 | setState(prev => ({ ...prev, showCreateModal: open })) | ^ 354 | }> 355 | <DialogTrigger asChild> 356 | <Button"

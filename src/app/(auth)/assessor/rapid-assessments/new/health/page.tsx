...
import { HealthAssessmentForm } from '@/components/forms/assessment'
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Evaluate medical facilities, services, and health needs
            </p>
          </div>
        </div>
        <OfflineIndicator />
                        ...
                        >
                          <div className="flex flex-col">
                            <span className="text-sm font-medium">
                              {draft.data.healthAssessment?.healthFacilityType || 'Draft'} - {draft.data.affectedEntityId || 'Unknown Entity'}
                            </span>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-medium mb-2">Medical Facilities:</h4>
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>• Count all functional health facilities</li>
                  <li>• Assess facility condition and equipment</li>
                  <li>• Note availability of essential medicines</li>
                  <li>• Identify specialized services available</li>
                </ul>
              </div>
              <div>
                <h4 className="font-medium mb-2">Health Services:</h4>
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>• Assess maternal and child health services</li>
                  <li>• Evaluate disease surveillance systems</li>
                  <li>• Note common health complaints</li>
                  <li>• Identify mental health support needs</li>
                </ul>
              </div>
            </div>
          </CardContent>

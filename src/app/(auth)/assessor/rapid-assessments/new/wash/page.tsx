...
import { WASHAssessmentForm } from '@/components/forms/assessment'
...
export default function WASHAssessmentPage() {
    ...
    <div className="container mx-auto px-4 py-8 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">WASH Assessment</h1>
            <p className="text-gray-600">
              Evaluate water, sanitation, and hygiene facilities and services
            </p>
          </div>
        </div>
        <OfflineIndicator />
                        ...
                        >
                          <div className="flex flex-col">
                            <span className="text-sm font-medium">
                              {draft.data.washAssessment?.waterSource ? `${draft.data.washAssessment.waterSource.join(', ')} Assessment` : 'WASH Draft'} - {draft.data.affectedEntityId || 'Unknown Entity'}
                            </span>
      ...
      {showForm && (
        <Card>
          <CardHeader>
            <CardTitle>WASH Assessment Form</CardTitle>
            <CardDescription>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>• Identify all available water sources</li>
                  <li>• Assess water quantity and accessibility</li>
                  <li>• Evaluate water quality concerns</li>
                  <li>• Note collection methods and time</li>
                </ul>
              </div>
              <div>
                <h4 className="font-medium mb-2">Sanitation Facilities:</h4>
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>• Count functional latrines/toilets</li>
                  <li>• Assess facility cleanliness and safety</li>
                  <li>• Evaluate accessibility for vulnerable groups</li>
                  <li>• Identify open defecation risks</li>
                </ul>
              </div>
            </div>
          </CardContent>

...
import { SecurityAssessmentForm } from '@/components/forms/assessment'
...
export default function SecurityAssessmentPage() {
  ...
  const handleSecuritySubmit = async (data: any) => {
    console.log('Security assessment submitted:', data)
    ...
    <div className="container mx-auto px-4 py-8 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Security Assessment</h1>
            <p className="text-gray-600">
              Evaluate protection, safety, and security conditions
            </p>
          </div>
        </div>
        <OfflineIndicator />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        >
                          <div className="flex flex-col">
                            <span className="text-sm font-medium">
                              {draft.data.securityAssessment ? `Security Assessment` : 'Security Draft'} - {draft.data.affectedEntityId || 'Unknown Entity'}
                            </span>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              Submitted security assessments
            </p>
      ...
      {showForm && (
        <Card>
          <CardHeader>
            <CardTitle>Security Assessment Form</CardTitle>
            <CardDescription>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-medium mb-2">Safety Conditions:</h4>
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>• Assess overall security situation</li>
                  <li>• Identify threats and risks</li>
                  <li>• Evaluate protection mechanisms</li>
                  <li>• Note security incidents and patterns</li>
                </ul>
              </div>
              <div>
                <h4 className="font-medium mb-2">Protection Issues:</h4>
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>• Identify vulnerable groups</li>
                  <li>• Assess GBV risks and reporting</li>
                  <li>• Evaluate child protection concerns</li>
                  <li>• Note protection measures in place</li>
                </ul>
              </div>
            </div>
          </CardContent>

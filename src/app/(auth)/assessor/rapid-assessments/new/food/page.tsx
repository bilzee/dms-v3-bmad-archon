...
import { FoodAssessmentForm } from '@/components/forms/assessment'
    ...
    <div className="container mx-auto px-4 py-8 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Food Security Assessment</h1>
            <p className="text-gray-600">
              Evaluate food availability, access, and nutrition needs
            </p>
          </div>
        </div>
        <OfflineIndicator />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        >
                          <div className="flex flex-col">
                            <span className="text-sm font-medium">
                              {draft.data.foodAssessment?.foodSource ? `${draft.data.foodAssessment.foodSource.join(', ')} Assessment` : 'Food Security Draft'} - {draft.data.affectedEntityId || 'Unknown Entity'}
                            </span>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              Submitted food security assessments
            </p>
      ...
      {showForm && (
        <Card>
          <CardHeader>
            <CardTitle>Food Security Assessment Form</CardTitle>
            <CardDescription>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-medium mb-2">Food Availability:</h4>
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>• Assess staple food availability</li>
                  <li>• Evaluate market functionality</li>
                  <li>• Check food supply chain disruptions</li>
                  <li>• Identify food shortage concerns</li>
                </ul>
              </div>
              <div>
                <h4 className="font-medium mb-2">Nutrition Status:</h4>
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>• Evaluate nutritional diversity</li>
                  <li>• Identify malnutrition indicators</li>
                  <li>• Assess vulnerable group needs</li>
                  <li>• Note feeding programs available</li>
                </ul>
              </div>
            </div>
          </CardContent>
